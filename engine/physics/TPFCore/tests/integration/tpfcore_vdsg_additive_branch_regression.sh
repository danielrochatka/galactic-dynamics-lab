...
grep -Eq "tpfcore_enable_provisional_readout=true is deprecated and cannot be used with simulation_mode=galaxy|tpf_dynamics_mode must be tpf_xi_theta_v1 on this branch" "$OUT/stderr.txt"
