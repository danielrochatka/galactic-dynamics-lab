...
Run-level effective IC/mode conditions are resolved by `engine/resolved_scenario.cpp` and emitted to `resolved_scenario.txt/json`; this scope file does not define scenario defaults.
