...
std::vector<PackageMetadataEntry> TPFCorePackage::run_info_metadata(const Config& config,
                                                                    const std::string& package_defaults_path) const {
  ...
  if (config.simulation_mode == SimulationMode::tpf_4d_static_residual_benchmark) {
    ...
    add("tpf_4d_static_residual_benchmark_particle_integration", "0");
    add("tpf_4d_static_residual_benchmark_acceleration_path", "none");
    add("tpf_4d_static_residual_benchmark_evaluator", "evaluate_static_configuration_residual_4d(...)");
    add("tpf_4d_static_residual_benchmark_field_objects", "static_Xi4_ordered_Theta4");
    add("tpf_4d_static_residual_benchmark_residual_support", "full_spatial_support_x_y_z_stencil");
    add("tpf_4d_static_residual_benchmark_time_terms", "intentionally_zero_by_static_assumption");
    add("tpf_4d_static_residual_benchmark_artifacts",
        "tpf_4d_static_residual_summary.txt;tpf_4d_static_residual_slice.csv;tpf_4d_static_residual_slice_xy.csv;"
    ...
    add("tpf_4d_static_residual_benchmark_visualization_note",
        "view_plane_renderings_derived_from_full_spatial_support_static_4d_residual_evaluation");
    add("tpf_4d_static_residual_benchmark_plot_png_note",
        "optional_view_plane_diagnostic_pngs_generated_only_when_plot_flag_supplied_and_plot_script_succeeds");
    add("tpf_4d_static_residual_benchmark_bins_note",
        "binned_residual_files_provide_quantitative_static_field_evidence_for_the_4d_residual_benchmark_and_support_regression_comparison_across_runs");
    add("tpf_4d_static_residual_benchmark_scope",
        "static_residual_benchmark_exercises_static_Xi4_ordered_Theta4_full_spatial_support_x_y_z_stencil");
    add("tpf_4d_static_residual_benchmark_unexercised_scope",
        "dynamics_moving_sources_physical_coupling_orbital_behavior_and_DeltaC_closure_are_not_exercised_by_this_benchmark");
    if (package_defaults_path.find("TPFCore") == std::string::npos &&
        !package_defaults_path.empty()) {
      add("tpf_4d_static_residual_benchmark_package_defaults_note",
          "residual_evaluator_path_is_tpfcore_static_4d_evaluate_static_configuration_residual_4d; layered_package_defaults_provenance_line_is_inherited_loader_selection_and_not_the_active_residual_evaluator_path");
    }
    add("=== End TPF 4D static residual benchmark note ===", "");
  } else if (config.simulation_mode == SimulationMode::tpf_4d_static_motion_readout_benchmark) {
    add("=== TPF 4D static motion readout benchmark ===", "");
    add("tpf_4d_static_motion_readout_benchmark_mode", "probe_motion_readout_benchmark");
    add("tpf_4d_static_motion_readout_benchmark_evaluator", "evaluate_static_sources_field_4d(...)");
    add("tpf_4d_static_motion_readout_benchmark_readout_name", "GravityStaticMotionReadout_v1");
    add("tpf_4d_static_motion_readout_benchmark_field_objects", "static_Xi4_ordered_Theta4");
    add("tpf_4d_static_motion_readout_benchmark_principal_tensor",
        "spatial_principal_tensor_readout_with_DeltaC_omitted_for_named_benchmark");
    add("tpf_4d_static_motion_readout_benchmark_newtonian_acceleration_calls", "0");
    add("tpf_4d_static_motion_readout_benchmark_compute_accelerations_calls", "0");
    add("tpf_4d_static_motion_readout_benchmark_particle_integration", "0");
    add("tpf_4d_static_motion_readout_benchmark_artifacts",
        "tpf_4d_static_motion_readout_summary.txt;tpf_4d_static_motion_readout_probe_grid.csv;tpf_4d_static_motion_readout_bins_origin.csv");
    add("tpf_4d_static_motion_readout_benchmark_scope", "static_field_to_candidate_probe_motion_readout_pipeline");
    add("tpf_4d_static_motion_readout_benchmark_unexercised_scope",
        "dynamics_moving_sources_orbits_physical_coupling_and_full_DeltaC_closure");
    add("=== End TPF 4D static motion readout benchmark note ===", "");
  } else if (config.simulation_mode == SimulationMode::tpf_4d_xi_motion_probe_benchmark) {
    add("=== TPF 4D Xi motion probe benchmark ===", "");
    add("tpf_4d_xi_motion_probe_benchmark_mode", "dynamic_probe_motion_benchmark");
    add("tpf_4d_xi_motion_probe_benchmark_readout", "GravityXiMotionReadout_v1");
    add("tpf_4d_xi_motion_probe_benchmark_acceleration_formula", "a=-K_xi*Xi_spatial");
    add("tpf_4d_xi_motion_probe_benchmark_evaluator", "evaluate_static_sources_field_4d(...)");
    add("tpf_4d_xi_motion_probe_benchmark_source_behavior", "fixed_sources_for_stage_7b");
    add("tpf_4d_xi_motion_probe_benchmark_probe_behavior", "moving_probes");
    add("tpf_4d_xi_motion_probe_benchmark_newtonian_acceleration_calls", "0");
    add("tpf_4d_xi_motion_probe_benchmark_compute_accelerations_calls", "0");
    add("tpf_4d_xi_motion_probe_benchmark_compute_direct_tpf_accelerations_calls", "0");
    add("tpf_4d_xi_motion_probe_benchmark_principal_c_tensor_acceleration", "0");
    add("tpf_4d_xi_motion_probe_benchmark_vdsg_shunt_cooling", "0");
    add("tpf_4d_xi_motion_probe_benchmark_production_dynamics_route", "0");
    add("tpf_4d_xi_motion_probe_benchmark_artifacts",
        "tpf_4d_xi_motion_probe_summary.txt;tpf_4d_xi_motion_probe_trajectories.csv;tpf_4d_xi_motion_probe_initial_readout.csv");
...
void TPFCorePackage::write_run_info_section(std::ostream& out,
                                            const Config& config,
                                            const RunInfoContext&,
                                            PackageRunInfoSection section) const {
  if (section == PackageRunInfoSection::BranchDiagnosticsSupplement) {
    if (config.tpf_dynamics_mode == "legacy_readout") {
    ...
    out << "tpf_global_accel_shunt_enable\t" << (config.tpf_global_accel_shunt_enable ? 1 : 0) << "\n";
    out << "tpf_global_accel_shunt_fraction\t" << config.tpf_global_accel_shunt_fraction << "\n";
    out << "tpf_accel_pipeline_diagnostics_csv\t" << (config.tpf_accel_pipeline_diagnostics_csv ? 1 : 0) << "\n";
    return;
  }
  if (section == PackageRunInfoSection::PostCodeProvenance) {
    if (config.simulation_mode == SimulationMode::tpf_4d_static_residual_benchmark) {
      out << "=== TPFCore (4D static residual benchmark only: dynamics routing not operative) ===\n";
      out << "note\tlayered config may still set tpf_dynamics_mode, tpfcore_enable_provisional_readout, readout_mode; they are inherited only and not used for particle accelerations in this static benchmark mode\n";
      out << "fixed_theory\tlambda=1/4 (LAMBDA_4D; fixed in code; not tunable)\n";
      out << "numerical_regularization\ttpfcore_source_softening, effective_source_softening (eps for Phi)\n";
      out << "inspection\ttpfcore_probe_radius_min/max, probe_samples (sampling range for static residual benchmark)\n";
      out << "=== End TPFCore 4D static residual benchmark note ===\n\n";
    } else if (config.simulation_mode == SimulationMode::tpf_4d_static_motion_readout_benchmark) {
      out << "=== TPFCore (4D static motion readout benchmark only: dynamics routing not operative) ===\n";
      out << "note\tbenchmark evaluates frozen static Xi4/Theta4 field points and computes GravityStaticMotionReadout_v1\n";
      out << "fixed_theory\tlambda=1/4 (LAMBDA_4D; fixed in code; not tunable)\n";
      out << "numerical_regularization\ttpf_4d_motion_field_softening (eps in evaluate_static_sources_field_4d)\n";
      out << "benchmark_knobs\ttpf_4d_motion_probe_grid_n/half_extent/source_exclusion_radius/field_softening/kappa/readout_scale/bin_count\n";
      out << "=== End TPFCore 4D static motion readout benchmark note ===\n\n";
    } else if (config.simulation_mode == SimulationMode::tpf_4d_xi_motion_probe_benchmark) {
      out << "=== TPFCore (4D Xi motion probe benchmark only: production dynamics routing not operative) ===\n";
      out << "note\tdynamic probe-motion benchmark using Xi-direct acceleration readout from fixed-source 4D field evaluation\n";
      out << "fixed_theory\tlambda=1/4 (LAMBDA_4D; fixed in code; not tunable)\n";
      out << "numerical_regularization\ttpf_4d_xi_motion_field_softening (eps in evaluate_static_sources_field_4d)\n";
      out << "benchmark_knobs\ttpf_4d_xi_motion_dt/steps/readout_scale/field_softening/source_exclusion_radius/probe_layout/probe_count/probe_radius/probe_speed/integrator/dump_every\n";
      out << "=== End TPFCore 4D Xi motion probe benchmark note ===\n\n";
    } else {
      out << "=== TPFCore parameter roles (theory vs regularization vs exploratory vs provisional) ===\n";
      out << "fixed_theory\tlambda=1/4 (LAMBDA_4D; fixed in code; not tunable)\n";
      out << "numerical_regularization\ttpfcore_source_softening, effective_source_softening (eps for Phi)\n";
      out << "dynamics_routing\ttpf_dynamics_mode (legacy_readout vs v11_weak_field_truncation vs direct_tpf); xi_kernel_deformed uses runtime Xi-kernel deformation with a=-tpf_4d_xi_motion_readout_scale*Xi_eff_spatial and no additive VDSG; legacy_readout uses tpfcore_enable_provisional_readout as gate; v11_weak_field_truncation is the Eq.42-44 weak-field correspondence helper (alpha_si correspondence path); direct_tpf is canonical paper-facing tensor principal-part route (field_evaluation -> Theta3D -> principal_Cij -> Xi_directed_tensor_readout; DeltaC omitted; additive VDSG extension)\n";
      out << "provisional_readout\ttpfcore_enable_provisional_readout (gate to legacy_readout accelerations), readout_mode (configured label; may differ from integrator ax,ay path when tpf_vdsg_coupling != 0 on legacy_readout), readout_scale, theta_tt_scale, theta_tr_scale, dump_readout_debug (experimental readout closures; diagnostics)\n";
      out << "inspection\ttpfcore_probe_radius_min/max, probe_samples, dump_theta_profile, dump_invariant_profile\n";
      out << "=== End TPFCore parameter roles ===\n\n";
    }
    return;
  }
  if (section == PackageRunInfoSection::LateRuntimeDetails) {
    const double src_eps = (config.tpfcore_source_softening > 0.0) ? config.tpfcore_source_softening : config.softening;
    ...
    if (!benchmark_mode) {
      ...
      out << "tpfcore_enable_provisional_readout\t" << (config.tpfcore_enable_provisional_readout ? 1 : 0) << "\n";
    } else if (config.simulation_mode == SimulationMode::tpf_4d_static_residual_benchmark) {
      out << "tpf_4d_static_residual_benchmark_repeat_note\ttpf_dynamics_mode / provisional readout: see resolved config section above (configured vs effective; not operative)\n";
    } else if (config.simulation_mode == SimulationMode::tpf_4d_static_motion_readout_benchmark) {
      out << "tpf_4d_static_motion_readout_benchmark_repeat_note\ttpf_dynamics_mode / provisional readout: see resolved config section above (configured vs effective; not operative)\n";
    } else {
      out << "tpf_4d_xi_motion_probe_benchmark_repeat_note\ttpf_dynamics_mode / provisional readout: see resolved config section above (configured vs effective; not operative)\n";
    }
    out << "tpfcore_provisional_source_ansatz\t1\n";
    out << "tpfcore_source_softening\t" << src_eps << "\n";
    out << "tpfcore_probe_radius_min\t" << config.tpfcore_probe_radius_min << "\n";
    out << "tpfcore_probe_radius_max\t" << config.tpfcore_probe_radius_max << "\n";
    out << "tpfcore_probe_samples\t" << config.tpfcore_probe_samples << "\n";
    out << "tpfcore_residual_method\tanalytic\n";
    out << "tpfcore_residual_step\t" << config.tpfcore_residual_step << "\n";
    if (!benchmark_mode) {
      out << "tpfcore_readout_mode\t" << config.tpfcore_readout_mode << "\n";
    } else if (config.simulation_mode == SimulationMode::tpf_4d_static_residual_benchmark) {
      out << "tpf_4d_static_residual_benchmark_repeat_readout_mode\tsee tpfcore_readout_mode_configured in resolved config section above\n";
    } else if (config.simulation_mode == SimulationMode::tpf_4d_static_motion_readout_benchmark) {
      out << "tpf_4d_static_motion_readout_benchmark_repeat_readout_mode\tsee tpfcore_readout_mode_configured in resolved config section above\n";
    } else {
      out << "tpf_4d_xi_motion_probe_benchmark_repeat_readout_mode\tsee tpfcore_readout_mode_configured in resolved config section above\n";
    }
  }
}
...
bool TPFCorePackage::write_post_run_diagnostics(const std::vector<Snapshot>& snapshots,
                                                const Config& config,
                                                const std::string& output_dir) {
  if (provisional_readout_enabled()) {
    const bool xi_field_diag = (config.tpf_dynamics_mode == "xi_kernel_deformed" &&
                                config.tpf_xi_kernel_dump_field_diagnostics);
    write_readout_debug(snapshots, config, output_dir);
    if (config.tpfcore_dump_readout_debug && config.tpf_dynamics_mode != "xi_kernel_deformed")
      std::cout << "Wrote " << output_dir << "/tpf_readout_debug.csv\n";
    write_regime_diagnostics(snapshots, config, output_dir);
    if (config.tpf_dynamics_mode != "xi_kernel_deformed" || xi_field_diag)
      std::cout << "Wrote " << output_dir << "/tpf_regime_diagnostics.txt\n";
    if (config.tpf_dynamics_mode != "xi_kernel_deformed" || xi_field_diag) {
      write_trajectory_diagnostics(snapshots, config, output_dir);
      std::cout << "Wrote " << output_dir << "/tpf_trajectory_diagnostics.txt\n";
      write_closure_diagnostics(snapshots, config, output_dir);
    }
    if ((config.tpf_dynamics_mode != "xi_kernel_deformed" || xi_field_diag) &&
        !snapshots.empty() && snapshots[0].state.n() == 1 &&
        (config.tpfcore_readout_mode == "tr_coherence_readout" || config.tpfcore_readout_mode == "experimental_radial_r_scaling"))
      std::cout << "Wrote " << output_dir << "/tpf_closure_diagnostics.csv, tpf_closure_diagnostics.txt\n";
    if (config.simulation_mode == galaxy::SimulationMode::bh_orbit_validation && !snapshots.empty() &&
        snapshots[0].state.n() == 1) {
      write_step0_orbit_audit(snapshots, config, output_dir);
      std::cout << "Wrote " << output_dir << "/tpf_step0_orbit_audit.txt\n";
    }
    if (config.tpfcore_live_orbit_force_audit) {
      write_live_orbit_force_audit(snapshots, config, output_dir);
      std::cout << "Wrote " << output_dir
                << "/tpf_live_orbit_force_audit.csv, tpf_live_orbit_force_audit.txt\n";
    }
  }
  if (config.tpf_dynamics_mode == "direct_tpf" && !snapshots.empty()) {
    write_step0_orbit_audit(snapshots, config, output_dir);
    std::cout << "Wrote " << output_dir
              << "/direct_tpf_step0_raw_accel_audit.csv, direct_tpf_step0_raw_accel_summary.txt\n";
  }
  if (config.save_run_info && config.tpf_dynamics_mode == "xi_kernel_deformed") {
    const auto counters = xi_runtime_counters();
    std::ofstream rf(output_dir + "/run_info.txt", std::ios::app);
    if (rf) {
