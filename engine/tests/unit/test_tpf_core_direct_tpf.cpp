...
TEST_CASE("direct_tpf config mapping is rejected on tpf_xi_theta_v1-only branch") {
  CHECK_THROWS(make_package("direct_tpf", -6.67430e-11, 1.3e4, 0.0));
  CHECK_THROWS(make_package("direct_tpf", -6.67430e-11, 2.6e4, 0.0));
}
